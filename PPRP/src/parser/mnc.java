	...
	final public void SwitchState() throws ParseException {
		...
		try {
			...
			label_4: while (true) {
				...
				quad = QTInfo.size + 1;
				/*
				 * Goto L语句，采用定义性出现，即以S产生的第一个四元式的序号作为 标号L的地址
				 */
				quad++;
...
//表达式
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x3e000, 0x3e000, 0x15abe800, 0x15abe800, 0x15abe800, 0x1023e000, 0x0, 0x800800,
				0x8000000, 0x1000, 0x0, 0x0, 0x0, 0x5080000, 0x0, 0x10000000, 0x90000080, 0x10000000, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x90000080, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x40, 0x40, 0x0, 0x0, 0x20, 0x0, 0x0, 0x0, 0x17c000, 0x17c000, 0x1c00000, 0x0,
				0x20, 0x0, 0x8, 0x0, 0x6000000, 0xc00, 0xc00, 0x203000, 0x203000, 0x8, };
	}
